...
** TRACY HTML/CSS & JavaScript Awesome-book** is a basic website that allows users to add/remove books from a list .
...
```sh
  cd my-folder
  git@github.com:Tracy-miranja/AWESOME-BOOK-ES6.git
```
...
This project is [MIT](https://github.com/Tracy-miranja/AWESOMEBOOK/compare/ES6...add-license-1~ licensed.
